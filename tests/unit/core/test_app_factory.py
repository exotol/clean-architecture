...
def test_create_app() -> None:
    # Arrange
    with patch("app.core.app_factory.AppContainer") as mock_container_cls, \
         patch("app.core.app_factory.load_settings") as mock_load_settings, \
        ...
        with patch("app.core.app_factory.create_middleware_list") as mock_create_middleware:
